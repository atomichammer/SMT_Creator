...
public:
    ...
    void setupUi(QDialog *DialogMoveRotate)
    {
        ...
        QWidget::setTabOrder(sbFirstX, sbFirstY);
        QWidget::setTabOrder(sbFirstY, sbSecondX);
        QWidget::setTabOrder(sbSecondX, sbSecondY);
        QWidget::setTabOrder(sbSecondY, buttonBox);
